...
public:
  ...
  // Tests
  bool egal(const XPt2D &M, const double &epsilon) const;
...
double dist(const XPt2D&, const XPt2D&);			// Distance
double dist2(const XPt2D&, const XPt2D&);			// Distance au carre

// Fonctions vectorielles
double prodScal(const XPt2D&, const XPt2D&);					// Produit Scalaire
double prodCross(const XPt2D&, const XPt2D&, const XPt2D&);	// Produit en croix
double area(const XPt2D&, const XPt2D&, const XPt2D&);       // Aire du triangle
double cap(const XPt2D&, const XPt2D&, const XPt2D&);        // Cap de la bissectrice

// Fonctions sur les droites
void droite(const XPt2D&, const XPt2D&, double& a, double& b, double& c);
double dist_droite(const XPt2D&, const XPt2D&, const XPt2D&);
